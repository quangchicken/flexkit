...
window.Shopify.updateOptionsInSelector = function (selectorIndex, parent) {
  ...
  $(`${parent}`).each(function () {
    $(this).find(`.swatch[data-option-index="${selectorIndex}"] .swatch-element`).each(function () {
